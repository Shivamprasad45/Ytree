...
import { Gift, Share2, Users, Award, Sparkles, CheckCircle2 } from "lucide-react"
...
import { CopyIcon, ChevronRightIcon } from "@radix-ui/react-icons"
...
export default function ReferralPage() {
  ...
  const progressPercentage = Math.min((referralStats.totalReferred / 10) * 100, 100)
    ...
    return (
      <MaxWidthRappers>
        <div className="flex flex-col justify-center items-center min-h-screen gap-4">
          ...
          <p className="text-muted-foreground animate-pulse">Loading your referral dashboard...</p>
        </div>
      </MaxWidthRappers>
    )
  }
      ...
      <MaxWidthRappers>
        <div className="flex flex-col items-center justify-center min-h-[70vh] p-6 text-center">
          ...
          >
            ...
            <h1 className="text-3xl font-bold mb-4">Join Our Referral Program</h1>
            <p className="text-muted-foreground mb-8">
              Sign in to access exclusive rewards and share the benefits with your friends and family.
            </p>
    ...
    <MaxWidthRappers>
      ...
      >
        <div className="text-center mb-10">
          <motion.div initial={{ y: -20 }} animate={{ y: 0 }} transition={{ duration: 0.5, delay: 0.2 }}>
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Invite friends, earn rewards, and watch your garden flourish with each successful referral.
            </p>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <SkyLanternReferral referralCount={referralStats.totalReferred} targetCount={10} />
        </motion.div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <Card className="overflow-hidden border-2 border-green-100 dark:border-green-900/30">
                  <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 pb-2">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-lg font-semibold">Total Referrals</CardTitle>
                      <Users className="h-5 w-5 text-green-600 dark:text-green-400" />
                    </div>
                  </CardHeader>
                  <CardContent className="pt-6">
                    <div className="flex items-end gap-2">
                      <div className="text-4xl font-bold">{referralStats.totalReferred}</div>
                      <div className="text-sm text-muted-foreground mb-1">/ 10 goal</div>
                    </div>
                    <Progress value={progressPercentage} className="h-2 mt-4 bg-green-100 dark:bg-green-900/30" />
                    <p className="text-sm text-muted-foreground mt-4">People who signed up using your link</p>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              >
                <Card className="overflow-hidden border-2 border-green-100 dark:border-green-900/30">
                  <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 pb-2">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-lg font-semibold">Rewards Earned</CardTitle>
                      <Gift className="h-5 w-5 text-green-600 dark:text-green-400" />
                    </div>
                  </CardHeader>
                  <CardContent className="pt-6">
                    <div className="flex items-center gap-2">
                      <div className="text-4xl font-bold">{referralStats.rewards}</div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <Card className="border-2 border-green-100 dark:border-green-900/30 overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
                  ...
                  <CardDescription>
                    Invite friends and earn rewards when they sign up and make their first purchase
                  </CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <Card className="border-2 border-green-100 dark:border-green-900/30">
                <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
                  ...
                  <CardDescription>
                    Follow these simple steps to earn rewards through our referral program
                  </CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h3 className="font-medium mb-1">Share your unique link</h3>
                        <p className="text-sm text-muted-foreground">
                          Copy your personal referral link and share it with friends and family through email, social
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          When someone clicks your link and creates an account, they're automatically connected to you
                          as a referral.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          You earn points when your referrals make their first purchase. They also receive a special
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h3 className="font-medium mb-1">Watch your garden grow</h3>
                        <p className="text-sm text-muted-foreground">
                          Each successful referral adds a new element to your virtual garden. Reach milestones to unlock
                ...
                <CardFooter className="flex justify-center pt-2 pb-6">
                  <Button
                    variant="outline"
                    className="border-2 border-green-200 dark:border-green-900 hover:border-green-300 dark:hover:border-green-800 transition-all"
                    onClick={() => document.querySelector('[data-value="share"]')?.click()}
                  >
                    Start Sharing Now
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            <div
              className={`p-4 rounded-lg border-2 ${referralStats.totalReferred >= 3 ? "bg-white dark:bg-green-900/20 border-green-300 dark:border-green-700" : "bg-muted/50 border-muted"}`}
            >
              <div className="text-lg font-medium mb-1">3 Referrals</div>
              <div className="text-sm text-muted-foreground mb-2">Free shipping on next order</div>
            ...
            <div
              className={`p-4 rounded-lg border-2 ${referralStats.totalReferred >= 5 ? "bg-white dark:bg-green-900/20 border-green-300 dark:border-green-700" : "bg-muted/50 border-muted"}`}
            >
              <div className="text-lg font-medium mb-1">5 Referrals</div>
              <div className="text-sm text-muted-foreground mb-2">15% discount coupon</div>
            ...
            <div
              className={`p-4 rounded-lg border-2 ${referralStats.totalReferred >= 10 ? "bg-white dark:bg-green-900/20 border-green-300 dark:border-green-700" : "bg-muted/50 border-muted"}`}
            >
              <div className="text-lg font-medium mb-1">10 Referrals</div>
              <div className="text-sm text-muted-foreground mb-2">Free premium product</div>
