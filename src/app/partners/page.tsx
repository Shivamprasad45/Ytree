    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="relative pt-20 pb-16 overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_0%,rgba(34,197,94,0.05),transparent_50%)]" />
                <MaxWidthRappers>
                    <motion.div
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-50 text-green-700 text-xs font-bold uppercase tracking-wider mb-2">
                            <Handshake className="w-3.5 h-3.5" />
                            Our Global Network
                        </div>
                        <h1 className="text-4xl md:text-6xl font-black text-gray-900 leading-tight">
                            Growing Together with <span className="text-green-600">World-Class Partners</span>
                        </h1>
                ...
                <MaxWidthRappers>
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="group relative p-8 rounded-[2.5rem] bg-gray-50 border border-gray-100 shadow-sm hover:shadow-xl hover:bg-white transition-all duration-500 overflow-hidden"
                        >
                            ...
                            <div className="relative z-10 space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="text-xl font-bold text-gray-600 uppercase tracking-wide">NGO Partners</div>
                                </div>
                                <p className="text-gray-500 font-medium">
                                    Ground-level organizations executing impactful reforestation projects across various biomes and territories.
                                </p>
                                <Button variant="link" className="px-0 text-green-600 font-bold group-hover:gap-3 transition-all">
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="text-xl font-bold text-gray-600 uppercase tracking-wide">Corporate Allies</div>
                                </div>
                                <p className="text-gray-500 font-medium">
                                    Businesses committed to sustainability and carbon neutrality, funding global environmental initiatives.
                                </p>
                                <Button variant="link" className="px-0 text-blue-600 font-bold group-hover:gap-3 transition-all">
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                            <div className="space-y-2">
                                <h2 className="text-3xl font-black text-gray-900">Partner Directory</h2>
                                <p className="text-gray-500 font-medium">Discover organizations driving environmental change.</p>
                            </div>
                            <div className="relative w-full md:w-96">
                                <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                                <Input
                                    className="pl-12 rounded-2xl border-gray-100 bg-gray-50 focus:bg-white h-12 text-sm font-medium"
                        ...
                        <Tabs defaultValue="NGO" className="space-y-8">
                            <TabsList className="bg-gray-50 p-1.5 rounded-2xl h-14 w-fit border border-gray-100">
                                <TabsTrigger value="NGO" className="rounded-xl px-8 h-full data-[state=active]:bg-white data-[state=active]:shadow-lg active:scale-95 transition-all text-sm font-bold">
                                    NGOs ({partners.filter(p => p.role === "NGO").length})
                                </TabsTrigger>
                                <TabsTrigger value="CORPORATE" className="rounded-xl px-8 h-full data-[state=active]:bg-white data-[state=active]:shadow-lg active:scale-95 transition-all text-sm font-bold">
                                ...
                                <TabsContent key={role} value={role} className="mt-0">
                                    {isPartnersLoading ? (
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            {[1, 2, 3].map(i => (
                                                <div key={i} className="h-64 rounded-[2.5rem] bg-gray-50 animate-pulse border border-gray-100" />
                                            ))}
                                        </div>
                                    ) : (
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                                ...
                                                .map((partner) => {
                                                    ...
                                                    return (
                                                        <motion.div
                                                            ...
                                                            viewport={{ once: true }}
                                                            className="group flex flex-col p-6 rounded-[2.5rem] bg-white border border-gray-100 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-500"
                                                        >
                                                            <div className="flex items-start justify-between mb-8">
                                                                <div className="relative">
                                                                    <Avatar className="w-16 h-16 border-2 border-gray-50 shadow-md">
                                                                ...
                                                                <div className="flex flex-col items-end gap-2">
                                                                    <Badge variant="secondary" className="bg-gray-100 text-gray-600 font-bold text-[10px] rounded-lg">
                                                            ...
                                                            <div className="mt-8 pt-6 border-t flex flex-col gap-4">
                                                                <div className="flex items-center justify-between">
                                                                    <div className="flex gap-1">
                                                                        ...
                                                                        <span className="text-[10px] font-black uppercase text-gray-400 tracking-wider">Verified Partner</span>
                                                                    </div>
                                                                    <Button
                                                                        variant="outline"
                                                                        size="sm"
                                                                        className="rounded-xl font-bold text-xs px-5 border-gray-100 hover:bg-gray-50 transition-all active:scale-95"
                                                                        onClick={() => {
                ...
                <MaxWidthRappers>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                        <div className="space-y-4">
                            <div className="mx-auto p-4 bg-white rounded-3xl w-fit shadow-md border border-gray-100 text-green-600">
                                <Globe className="w-8 h-8" />
                            </div>
                            <h3 className="text-xl font-bold text-gray-900">Global Presence</h3>
                            <p className="text-gray-500 font-medium">Operating in 30+ countries with localized expertise and sustainable practices.</p>
                        </div>
                        <div className="space-y-4">
                            <div className="mx-auto p-4 bg-white rounded-3xl w-fit shadow-md border border-gray-100 text-green-600">
                                <ShieldCheck className="w-8 h-8" />
                            </div>
                            <h3 className="text-xl font-bold text-gray-900">Verified Impact</h3>
                            <p className="text-gray-500 font-medium">Rigorous audit processes for every tree planted and every carbon credit generated.</p>
                        </div>
                        <div className="space-y-4">
                            <div className="mx-auto p-4 bg-white rounded-3xl w-fit shadow-md border border-gray-100 text-green-600">
                                <Handshake className="w-8 h-8" />
                            </div>
                            <h3 className="text-xl font-bold text-gray-900">Transparent Partnership</h3>
                            <p className="text-gray-500 font-medium">Real-time reporting and blockchain-verified tracking for all environmental contributions.</p>
                        </div>
                    </div>
                </MaxWidthRappers>
            </section>
            ...
            <section className="py-20">
                <MaxWidthRappers>
                    <div className="p-12 rounded-[3.5rem] bg-gradient-to-br from-green-600 to-green-700 text-white text-center space-y-8 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                            ...
                            <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 px-10 rounded-2xl font-bold backdrop-blur-sm">
                                Contact Support
                            </Button>
                        </div>
                    </div>
