  ...
  return (
    <div>
      <div>
        ...
        {show && (
          <div
            className="w-full h-full max-w-screen-lg ml-6 bg-black bg-opacity-90 top-20 overflow-y-auto overflow-x-hidden fixed sticky-0"
            id="chec-div"
          >
            <div
                ...
                <div className="xl:w-1/2 md:w-1/3  w-full bg-gray-100 h-full">
                  <div className="flex flex-col md:h-screen px-14 py-20 justify-between overflow-y-auto">
                    ...
                    <div>
                      ...
                      >
                        <Link href="Tree/Cart/Checkout">Checkout</Link>
                      </button>
                    </div>
                  </div>
                </div>
